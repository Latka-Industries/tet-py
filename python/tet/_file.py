...
class TetFile:
    ...
    def typing_stub(self) -> str:
        ...
        Opt-in only; does not run on :func:`tet.open`. Save the string beside your code
        if you want Pyright/Pylance hints for a fixed path.
        """
        lines = [
    ...
    def info(self) -> dict[str, Any]:
        """Alias for :meth:`summary` (full ``tet info --json``, including all chunks)."""
        return self.summary()
